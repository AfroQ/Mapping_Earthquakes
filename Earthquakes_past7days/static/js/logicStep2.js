...
// Create a base layer that holds streets and satellite maps.
let baseMaps = {
  "Streets": streets,
...
d3.json(quakeDataURL).then(function(data) {
  /* This function returns the style data for each of the earthquakes we plot 
  on the map. We pass the magnitude of the earthquake into a function to 
  ...
  its magnitude. Earthquakes with a magnitude of 0 will be plotted with a 
  radius of 1. */
